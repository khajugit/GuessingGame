...
<%@ page import="com.factset.game.utilities.WebUtils"%>
<%@ page import="com.factset.game.beans.GuessNumberBean"%>

<%
	GuessNumberBean guessBean = new GuessNumberBean();

	//setting mininum value
	guessBean.setMinNumber(1);
	//setting Maximum value 
	guessBean.setMaxNumber(10);
	//setting actual number between min to max
	guessBean.setActualNumber(WebUtils.getRandomNumber(guessBean.getMinNumber(), guessBean.getMaxNumber()));
	//setting number of guessess
	guessBean.setNumberOfGuesses(0);
%>
...
<div class="gamestyle4">
	<form name="guessingForm" action="guessGame" method="post">
		...
		<input type="submit" value="Guess it" onclick="return validateform();" /><br> 
